...
<template>
    ...
    <section v-else class="container-sm container-xxl d-flex flex-column align-items-center">
        ...
        <div v-else class="wrapper-result">
            <h2 class="my-5">Ecco cosa abbiamo trovato in {{ this.address }}</h2>
            <div class="row">
                        ...
                        <div class="d-flex">
                            <div class="row me-5">
                                <div class="col">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button @click="getCardsFiltered()" type="button" class="btn-custom">Invia</button>
                                    </div>
                                </div>
                            </div>
                        </div>
